...
| Collection routes and collectors | `apps/api/src/routes/v2.ts`, `apps/api/src/v2/collectors/` | TS | Built: ADS-B, AIS, SEC EDGAR, open web, first-party telemetry, Sentinel-2, broker interface |
