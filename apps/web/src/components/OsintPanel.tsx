...
export function OsintPanel({
  ...
  /**
   * Hosts with coordinates, handed to the map.
   *
   * Censys is the only source that resolves below country level, so this is
   * usually a subset of the hosts found — which is why the panel still lists
   * everything and the map only shows what can honestly be placed.
   */
  useEffect(() => {
